...
![alt text](image.png)
August 15:
-12AM-3AM: I finished the main model. ![alt text](image-1.png)
-3AM-4:40AM: I tought that I could add more things so I made the keyboard bigger. And also added attachable parts. ![alt text](image-2.png)
...
August 18"
-2:30PM-3:30PM: I made some changes to the keyboard model. ![alt text](image-3.png)
